...
public class BarController  extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("small", paymentDAO.getList());
        request.setAttribute("medium", paymentDAO.getMap());
        request.setAttribute("big", paymentDAO.getIntList());
...
/*
        response.setHeader("");*/
        RequestDispatcher view = request.getRequestDispatcher("bar.jsp");
